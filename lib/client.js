window.__ModuleLoader__.load({ id: "@gestaltrun/dsh-github-workbench", factory: (require) => {
var module = { exports: {} };
...
function WorkbenchTab(props) {
  ...
  (0, import_react9.useEffect)(() => props.ctx.betterSidebar.updateTab(props.tab.id, { title }), [props.ctx, props.tab.id, title]);
...
function mountAsTab(registry) {
  const descriptor = {
    ...
    component: (props) => (0, import_react9.createElement)(WorkbenchTab, props)
  };
